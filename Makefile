...
data/x_test.csv data/x_train.csv data/y_test.csv data/y_train.csv data/column_names.csv: scripts/preprocessing.py data/german_clean.csv
...
data/cross_validation_scores.csv data/linear-reg_coefficients.csv data/logistic_regression_C_optimization.csv data/test_scores.csv img/0_random_forest_tree.png img/1_random_forest_tree.png img/2_random_forest_tree.png img/roc_plot.png: scripts/model.py data/x_test.csv data/x_train.csv data/y_test.csv data/y_train.csv
...
reports/credit_risk_report.html: reports/credit_risk_report.qmd img/age.png img/credit_amount.png img/credit_risk.png img/duration.png img/existing_credits.png img/liable_people.png img/rate.png img/residence.png img/heatmap.png data/cross_validation_scores.csv data/linear-reg_coefficients.csv data/logistic_regression_C_optimization.csv data/test_scores.csv img/0_random_forest_tree.png img/1_random_forest_tree.png img/2_random_forest_tree.png img/roc_plot.png
	quarto render reports/credit_risk_report.qmd --to html

reports/credit_risk_report.pdf: reports/credit_risk_report.qmd img/age.png img/credit_amount.png img/credit_risk.png img/duration.png img/existing_credits.png img/liable_people.png img/rate.png img/residence.png img/heatmap.png data/cross_validation_scores.csv data/linear-reg_coefficients.csv data/logistic_regression_C_optimization.csv data/test_scores.csv img/0_random_forest_tree.png img/1_random_forest_tree.png img/2_random_forest_tree.png img/roc_plot.png
