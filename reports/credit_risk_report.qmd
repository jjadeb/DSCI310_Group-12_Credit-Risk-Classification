...
![Credit Amount](../img/Credit%20amount.png)
...
In @tbl-measures we see both the models are performing well  well on the test set, with relatively high accuracy, precision, recall, and F1 score. It correctly classifies a majority of instances while maintaining a good balance between false positives and false negatives. Here, in this instance we would want to avoid false negatives where a person at credit risk is not deemed to be at risk, and a high recall score ensures the model is performing well in avoiding false negatives. 

![ROC Curve](../img/roc_plot.png){#fig-roc width=90% style="text-align:center;"}
...
::: {#fig-rf layout-nrow=3}

![Tree 1](../img/0_random_forest_tree.png)

![Tree 2](../img/1_random_forest_tree.png)

![Tree 3](../img/2_random_forest_tree.png)
