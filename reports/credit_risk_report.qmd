...
accuracy_lr = round(measures_table1['Logistic Regression'].values[0],3)
precision_lr = round(measures_table1['Logistic Regression'].values[1],3)
recall_lr = round(measures_table1['Logistic Regression'].values[2],3)
F1_lr = round(measures_table1['Logistic Regression'].values[3],3)
```
```{python}
...
![Credit Amount](../img/Credit%20amount.png){width=80%}
...
accuracy_lr = measures_table['Logistic Regression'].values[0]
precision_lr = measures_table['Logistic Regression'].values[1]
recall_lr = measures_table['Logistic Regression'].values[2]
F1_lr = measures_table['Logistic Regression'].values[3]
